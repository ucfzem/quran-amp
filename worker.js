...
<head>
    ...
    <style>
        ...
        * {
        ...
        canvas#spectrum:hover { box-shadow: 0 0 12px var(--lcd-glow); }
        ...
        .reciter-trigger-btn:hover::after { transform: translateY(2px); }
        ...
        .btn-winamp.btn-toggle { width: 36px; height: 36px; }
        .btn-winamp.btn-toggle svg { width: 15px; height: 15px; }
        .btn-winamp.btn-toggle.active {
            background: var(--btn-active-bg);
            border-color: var(--accent);
            box-shadow: 0 0 10px rgba(212, 175, 55, 0.5);
        }
        .btn-winamp.btn-toggle.active svg { fill: #fff; }
        ...
        .mute-btn:hover { background: var(--btn-active-bg); }
        .mute-btn svg { width: 14px; height: 14px; fill: var(--btn-text); }
        ...
        .playlist-item:hover,
        .playlist-item:focus { background: var(--item-hover); }
        ...
        .playlist-item .surah-name { font-weight: 500; }
        ...
        .reciter-option:focus { background: var(--item-hover); }
        ...
        .mode-btn:hover { background: var(--btn-active-bg); }
        .mode-btn.active {
            background: var(--btn-active-bg);
            border-color: var(--accent);
            color: #fff;
        ...
        .speed-btn:hover { background: var(--btn-active-bg); }
        .speed-btn.active {
            background: var(--btn-active-bg);
            border-color: var(--accent);
            color: #fff;
...
<body>
    ...
    <script>
        const RECITERS = [
            ...
            { id: "Abdurrahmaan_As-Sudais_192kbps", name: "عبد الرحمن السديس", fb: ["sudais"] },
            ...
            { id: "Abu_Bakr_Ash-Shaatree_128kbps", name: "أبو بكر الشاطري", fb: ["abubakr"] },
        ...
        function buildAudioUrls(reciter, surahNum, ayahNum) {
            const s3 = pad3(surahNum), a3 = pad3(ayahNum);
            const urls = [];
            urls.push(AUDIO_SOURCES[0].url(reciter.id, s3, a3));
            if (reciter.fb && reciter.fb.length > 0) {
                urls.push(AUDIO_SOURCES[1].url(reciter.fb[0], s3));
            }
            return urls;
        }


        function buildBasmalahUrls(reciter) {
            const urls = [];
            urls.push(AUDIO_SOURCES[0].url(reciter.id, "001", "001"));
            if (reciter.fb && reciter.fb.length > 0) {
                urls.push(AUDIO_SOURCES[1].url(reciter.fb[0], "001"));
            }
            return urls;
        }


        async function playUrlChain(urls, idx, autoPlay = false, requestId = 0) {
        ...
        const VIZ_MODE_NAMES = ['\\u0623\\u0634\\u0631\\u0637\\u0629', '\\u0645\\u0646\\u062D\\u0646\\u0649', '\\u062A\\u0639\\u0628\\u0626\\u0629', '\\u062F\\u0648\\u0627\\u0626\\u0631', '\\u0645\\u0648\\u062C\\u0627\\u062A'];
        ...
        canvas.addEventListener('click', () => {
            ...
            updateVizIndicator();
            showToast('\\u0646\\u0645\\u0637 \\u0627\\u0644\\u0639\\u0631\\u0636: ' + VIZ_MODE_NAMES[vizMode], 1500);
        });


        function updateVizIndicator() {
            vizIndicator.textContent = '\\u0648\\u0636\\u0639: ' + VIZ_MODE_NAMES[vizMode];
        ...
        function drawActiveSpectrum() {
            ...
            switch (settings.visualizerMode) {
                case 0: drawBars(dataArray, accent, lcdText); break;
                case 1: drawCurve(dataArray, lcdText); break;
                case 2: drawFill(dataArray, accent, lcdText); break;
                case 3: drawCircles(dataArray, accent, lcdText); break;
                case 4: drawWaveform(dataArray, lcdText); break;
                default: drawBars(dataArray, accent, lcdText);
            }
        }
        ...
        function renderReciterList() {
            ...
            RECITERS.forEach((r) => {
                ...
                const selectHandler = () => {
                    ...
                    showToast('\\u062A\\u0645 \\u062A\\u063A\\u064A\\u064A\\u0631 \\u0627\\u0644\\u0642\\u0627\\u0631\\u0626 \\u0625\\u0644\\u0649: ' + r.name);
                };
        ...
        function setupSettingsUI() {
            document.querySelectorAll('#speed-btns .speed-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    applySettingsToUI();
                    showToast('\\u0633\\u0631\\u0639\\u0629 \\u0627\\u0644\\u062A\\u0634\\u063A\\u064A\\u0644: ' + spd + 'x');
                });
            });
            document.querySelectorAll('#repeat-btns .mode-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    applySettingsToUI();
                    const labels = { off: '\\u0625\\u064A\\u0642\\u0627\\u0641', one: '\\u062A\\u0643\\u0631\\u0627\\u0631 \\u0648\\u0627\\u062D\\u062F', all: '\\u062A\\u0643\\u0631\\u0627\\u0631 \\u0627\\u0644\\u0643\\u0644', shuffle: '\\u0639\\u0634\\u0648\\u0627\\u0626\\u064A' };
                    showToast('\\u0648\\u0636\\u0639 \\u0627\\u0644\\u062A\\u0643\\u0631\\u0627\\u0631: ' + labels[settings.repeatMode]);
                });
            });
            document.querySelectorAll('#color-swatches .color-swatch').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    applySettingsToUI();
                    showToast('\\u062A\\u0645 \\u062A\\u063A\\u064A\\u064A\\u0631 \\u0644\\u0648\\u0646 \\u0627\\u0644\\u0639\\u0631\\u0636 \\u0627\\u0644\\u0645\\u0631\\u0626\\u064A');
                });
            });
            document.querySelectorAll('#viz-mode-btns .mode-btn').forEach(btn => {
                btn.addEventListener('click', () => {
            ...
            document.querySelectorAll('#font-size-btns .mode-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    applySettingsToUI();
                    showToast('\\u062D\\u062C\\u0645 \\u0627\\u0644\\u062E\\u0637: ' + btn.textContent);
                });
            });
            document.getElementById('auto-scroll-toggle').addEventListener('click', () => {
                settings.autoScroll = !settings.autoScroll;
                applySettingsToUI();
                showToast(settings.autoScroll ? '\\u062A\\u0645 \\u062A\\u0641\\u0639\\u064A\\u0644 \\u0627\\u0644\\u062A\\u0645\\u0631\\u064A\\u0631 \\u0627\\u0644\\u062A\\u0644\\u0642\\u0627\\u0626\\u064A' : '\\u062A\\u0645 \\u0625\\u064A\\u0642\\u0627\\u0641 \\u0627\\u0644\\u062A\\u0645\\u0631\\u064A\\u0631 \\u0627\\u0644\\u062A\\u0644\\u0642\\u0627\\u0626\\u064A');
            });
            document.getElementById('perf-toggle').addEventListener('click', () => {
                settings.perf = !settings.perf;
                applyPerformanceMode();
                applySettingsToUI();
                showToast(settings.perf ? '\\u062A\\u0645 \\u062A\\u0641\\u0639\\u064A\\u0644 \\u0648\\u0636\\u0639 \\u0627\\u0644\\u0623\\u062F\\u0627\\u0621 \\u0627\\u0644\\u062E\\u0641\\u064A\\u0641' : '\\u062A\\u0645 \\u0625\\u064A\\u0642\\u0627\\u0641 \\u0648\\u0636\\u0639 \\u0627\\u0644\\u0623\\u062F\\u0627\\u0621 \\u0627\\u0644\\u062E\\u0641\\u064A\\u0641');
            });
        }
        ...
        function updateRepeatBtnIcon() {
            ...
            if (mode === 'off') {
                ...
                repeatBtn.title = '\\u0648\\u0636\\u0639 \\u0627\\u0644\\u062A\\u0643\\u0631\\u0627\\u0631: \\u0625\\u064A\\u0642\\u0627\\u0641';
            } else if (mode === 'one') {
                repeatBtn.classList.add('active');
                repeatBtn.title = '\\u0648\\u0636\\u0639 \\u0627\\u0644\\u062A\\u0643\\u0631\\u0627\\u0631: \\u0648\\u0627\\u062D\\u062F';
            } else if (mode === 'all') {
                repeatBtn.classList.add('active');
                repeatBtn.title = '\\u0648\\u0636\\u0639 \\u0627\\u0644\\u062A\\u0643\\u0631\\u0627\\u0631: \\u0627\\u0644\\u0643\\u0644';
            } else if (mode === 'shuffle') {
                repeatBtn.classList.add('active');
                repeatBtn.title = '\\u0648\\u0636\\u0639 \\u0627\\u0644\\u062A\\u0643\\u0631\\u0627\\u0631: \\u0639\\u0634\\u0648\\u0627\\u0626\\u064A';
            }
        }
        ...
        async function fetchSurahs() {
            try {
                ...
                showToast('\\u062E\\u0637\\u0623 \\u0641\\u064A \\u0627\\u0644\\u0627\\u062A\\u0635\\u0627\\u0644 \\u0628\\u0627\\u0644\\u062E\\u0627\\u062F\\u0645');
            }
        }
        ...
        function renderPlaylist() {
            ...
            filtered.forEach((s) => {
                ...
                item.innerHTML = '<span class="surah-name">' + s.number + '. ' + s.name + '</span><span class="surah-meta">' + s.numberOfAyahs + ' \\u0622\\u064A\\u0629</span>';
            ...
            if (filtered.length === 0) {
                ...
                empty.textContent = '\\u0644\\u0627 \\u062A\\u0648\\u062C\\u062F \\u0646\\u062A\\u0627\\u0626\\u062C';
        ...
        async function playAyah(index, autoPlay = true, requestId = null, skipBasmalah = false) {
            if (requestId === null) {
                activePlayRequestId++;
            ...
            arTextEl.innerHTML = ayahAr.text + ' <span class="ayah-marker">﴿' + ayahAr.numberInSurah + '﴾</span>';
            textContainer.scrollTop = 0;
            lcdAyahCount.textContent = '\\u0622\\u064A\\u0629 ' + ayahAr.numberInSurah + ' / ' + currentAyahsAr.length;
            seekBar.value = 0;

            const reciterObj = RECITERS.find(r => r.id === settings.reciterId) || RECITERS[0];
            if (autoPlay) initAudioContext();

            if (!skipBasmalah && index === 0 && surahNum !== 1 && surahNum !== 9) {
                isBasmalahPlaying = true;
                var ok = await playUrlChain(buildBasmalahUrls(reciterObj), 0, autoPlay, currentRequestId);
                if (!ok && currentRequestId === activePlayRequestId) {
                    isBasmalahPlaying = false;
                    await playUrlChain(buildAudioUrls(reciterObj, surahNum, 1), 0, autoPlay, currentRequestId);
                }
            } else {
                isBasmalahPlaying = false;
                await playUrlChain(buildAudioUrls(reciterObj, surahNum, index + 1), 0, autoPlay, currentRequestId);
            }
        ...
        function setPlayPauseUI(isPlaying) {
            if (playBtn) playBtn.style.display = isPlaying ? 'none' : '';
            if (pauseBtn) pauseBtn.style.display = isPlaying ? '' : 'none';
        }


        function onSurahCompleted() {
            setPlayPauseUI(false);
            if (settings.repeatMode === 'one') {
                playAyah(currentAyahIndex, true, activePlayRequestId, true);
            } else if (settings.repeatMode === 'all') {
                loadSurah((currentSurahIndex + 1) % surahs.length, true);
            } else if (settings.repeatMode === 'shuffle' || settings.shuffleEnabled) {
        ...
        function setupEventListeners() {
            ...
            audio.addEventListener('error', (e) => {
                ...
                showToast('تعذر تحميل هذا الآية. تحقق من الاتصال أو جرّب قارئاً آخر.');
                setPlayPauseUI(false);
            });
            ...
            muteBtn.addEventListener('click', () => {
                ...
                audio.volume = settings.muted ? 0 : volumeBar.value / 100;
                showToast(settings.muted ? '\\u062A\\u0645 \\u0643\\u062A\\u0645 \\u0627\\u0644\\u0635\\u0648\\u062A' : '\\u062A\\u0645 \\u062A\\u0634\\u063A\\u064A\\u0644 \\u0627\\u0644\\u0635\\u0648\\u062A');
            });
            ...
            shuffleBtn.addEventListener('click', () => {
                ...
                shuffleBtn.classList.toggle('active', settings.shuffleEnabled);
                showToast(settings.shuffleEnabled ? '\\u062A\\u0645 \\u062A\\u0641\\u0639\\u064A\\u0644 \\u0627\\u0644\\u062A\\u0634\\u063A\\u064A\\u0644 \\u0627\\u0644\\u0639\\u0634\\u0648\\u0627\\u0626\\u064A' : '\\u062A\\u0645 \\u0625\\u064A\\u0642\\u0627\\u0641 \\u0627\\u0644\\u062A\\u0634\\u063A\\u064A\\u0644 \\u0627\\u0644\\u0639\\u0634\\u0648\\u0627\\u0626\\u064A');
            });

            repeatBtn.addEventListener('click', () => {
                const modes = ['off', 'one', 'all', 'shuffle'];
                let nextIdx = (modes.indexOf(settings.repeatMode) + 1) % modes.length;
                settings.repeatMode = modes[nextIdx];
                applySettingsToUI();
                const labels = { off: '\\u0625\\u064A\\u0642\\u0627\\u0641', one: '\\u062A\\u0643\\u0631\\u0627\\u0631 \\u0648\\u0627\\u062D\\u062F', all: '\\u062A\\u0643\\u0631\\u0627\\u0631 \\u0627\\u0644\\u0643\\u0644', shuffle: '\\u0639\\u0634\\u0648\\u0627\\u0626\\u064A' };
                showToast('\\u0648\\u0636\\u0639 \\u0627\\u0644\\u062A\\u0643\\u0631\\u0627\\u0631: ' + labels[settings.repeatMode]);
            });
            ...
            themeBtn.addEventListener('click', () => {
                ...
                document.getElementById('theme-icon').textContent = nextTheme === 'light' ? '\\uD83C\\uDF19' : '\\u2600';
            });
